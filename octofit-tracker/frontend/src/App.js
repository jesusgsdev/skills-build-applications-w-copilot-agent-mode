    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="card text-center"><div className="card-body"><h2 className="card-title">Welcome to OctoFit Tracker!</h2><p className="card-text">Track your fitness, join teams, and compete on the leaderboard!</p></div></div>} />
        </Routes>
      </div>
    </Router>
  );
